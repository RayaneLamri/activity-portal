        ...
        <div class="col-12 col-lg-4">
            <div class="app-card app-card-basic shadow-sm h-100">
                <div class="app-card-body p-3 p-lg-4 h-100 d-flex flex-column">
                    ...
                    <a class="btn app-btn-secondary mt-auto align-self-start" href="{{ route('profile.edit') }}">Manage account</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-lg-4">
            <div class="app-card app-card-basic shadow-sm h-100">
                <div class="app-card-body p-3 p-lg-4 h-100 d-flex flex-column">
                    ...
                    <a class="btn app-btn-secondary mt-auto align-self-start" href="{{ route('activities.index') }}">Browse activities</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-lg-4">
            <div class="app-card app-card-basic shadow-sm h-100">
                <div class="app-card-body p-3 p-lg-4 h-100 d-flex flex-column">
                    ...
                    <a class="btn app-btn-secondary mt-auto align-self-start" href="{{ route('my-registrations.index') }}">My registrations</a>
                </div>
            </div>
        </div>
    </div>
