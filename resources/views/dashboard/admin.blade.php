    ...
    <div class="row g-4 mb-4">
        <div class="col-12 col-lg-4">
            <div class="app-card app-card-basic shadow-sm h-100">
                <div class="app-card-body p-3 p-lg-4 h-100 d-flex flex-column">
                    <h3 class="app-card-title mb-2">1. Registrations</h3>
                    <div class="text-muted mb-3">Review requests, invitations and decisions.</div>
                    <a class="btn app-btn-secondary mt-auto align-self-start" href="{{ route('admin.registrations.index') }}">Review registrations</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-lg-4">
            <div class="app-card app-card-basic shadow-sm h-100">
                <div class="app-card-body p-3 p-lg-4 h-100 d-flex flex-column">
                    ...
                    <a class="btn app-btn-secondary mt-auto align-self-start" href="{{ route('admin.users.index') }}">Manage users</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-lg-4">
            <div class="app-card app-card-basic shadow-sm h-100">
                <div class="app-card-body p-3 p-lg-4 h-100 d-flex flex-column">
                    ...
                    <a class="btn app-btn-secondary mt-auto align-self-start" href="{{ route('admin.registration-events.index') }}">View history</a>
                </div>
            </div>
        </div>
    </div>
