...
import { escapeHtml, green, grey } from './utils';
...
function listenForRegistrationRequestSubmission() {
...
function listenForInvitationResponseSubmission() {
    document.addEventListener('submit', async (event) => {
...
export function initUserRegistrationConfirmations() {
    listenForRegistrationRequestSubmission();
    listenForInvitationResponseSubmission();
}
