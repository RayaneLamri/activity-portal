...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $usersData = [
            ...
            ['name' => 'Stephanie Carpentier', 'email' => 'stephanie@example.test', 'is_active' => false],
        ...
        $preferences = [
            [
                ...
                'age_groups' => [UserPreference::AGE_LOWER, UserPreference::AGE_UPPER],
                'min_age' => 8,
                'max_age' => 16,
                'starts_on' => '2026-07-06',
                'ends_on' => '2026-10-30',
            ...
            [
                ...
                'age_groups' => [UserPreference::AGE_UPPER],
                'min_age' => 10,
                'max_age' => 15,
                'starts_on' => '2026-08-10',
                'ends_on' => '2026-08-14',
            ...
            [
                ...
                'age_groups' => [UserPreference::AGE_LOWER],
                'min_age' => 8,
                'max_age' => 14,
                'starts_on' => '2026-07-06',
                'ends_on' => '2026-10-30',
