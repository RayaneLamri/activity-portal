...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::table('activities')
            ...
            ->each(function ($activity): void {
                $ageGroup = match (true) {
                    $activity->max_age !== null && $activity->max_age <= 8 => UserPreference::AGE_PRESCHOOL,
                    $activity->min_age !== null && $activity->min_age >= 10 => UserPreference::AGE_UPPER,
                    default => UserPreference::AGE_LOWER,
                };
    ...
    private function ageGroupsForPreference(?int $minAge, ?int $maxAge): array
    {
        ...
        return collect(UserPreference::ageGroups())
