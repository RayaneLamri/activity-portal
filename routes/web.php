...
Route::get('/dashboard', DashboardController::class)->middleware(['auth', 'active_user', 'verified'])->name('dashboard');

Route::middleware(['auth', 'active_user', 'is_user'])->group(function () {
...
Route::middleware(['auth', 'is_admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::post('/registrations/invite', [AdminRegistrationController::class, 'invite'])->name('registrations.invite');
